 ...
 */
public class ConfidenceValueNormalization {
    /**
    ...
    private final static Logger log = LoggerFactory.getLogger(ConfidenceValueNormalization.class);
     ...
     */
    public ConfidenceValueNormalization(String name) {
     ...
     */
    public ConfidenceValueNormalization() {
