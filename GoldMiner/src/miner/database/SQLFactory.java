...
public class SQLFactory {
	...
	public String insertPropertyChainQuery( int iID, String sURI1, String sURI2, String sName1, String sName2 ){
		return "INSERT INTO property_chains VALUES ("+ iID +", '"+ sURI1 +"', '"+ sURI2 +"', '"+ sName1 +"', '"+ sName2 +"')";
	}
	...
	public String insertIndividualPairQuery( int id, String sURI1, String sURI2, String sName1, String sName2 ){
		return "INSERT INTO individual_pairs VALUES ("+ id +", '"+ sURI1 +"', '"+ sURI2 +"', '"+ sName1 +"', '"+ sName2 +"')";
	}
	
	public String insertIndividualPairTransQuery( int id, String sURI1, String sURI2, String sName1, String sName2 ){
		return "INSERT INTO individual_pairs_trans VALUES ("+ id +", '"+ sURI1 +"', '"+ sURI2 +"', '"+ sName1 +"', '"+ sName2 +"')";
	}
	...
	public String insertIndividualPairExtQuery( int id, String sURI1, String sURI2, String sName1, String sName2 ){
		return "INSERT INTO individual_pairs_ext VALUES ("+ id +", '"+ sURI1 +"', '"+ sURI2 +"', '"+ sName1 +"', '"+ sName2 +"')";
	}
	
	public String insertClassExistsPropertyQuery( int iID, String sPropURI, String sClassURI, String sPropName, String sClassName, int iSize ){
		return "INSERT INTO classes_ex_property VALUES ("+ iID +", '"+ sPropURI +"', '"+ sClassURI +"', '"+ sPropName +"', '"+ sClassName +"', "+ iSize +")";
	}
	
	public String insertClassExistsPropertyQuery( int iID, String sPropURI, String sClassURI, String sPropName, String sClassName ){
	...
	public String insertPropertyTopQuery( int iID, int iInv, String sPropURI, String sPropName ){
		return "INSERT INTO classes_ex_property_top VALUES ("+ iID +", "+ iInv +", '"+ sPropURI +"', '"+ sPropName +"')";
	}
