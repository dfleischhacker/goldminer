...
public class SPARQLQueryEngine extends QueryEngine {

    private final static Logger logger = LoggerFactory.getLogger(SPARQLQueryEngine.class);
	...
	public SPARQLQueryEngine(String endpoint, String graph, int chunk){
		m_sEndpoint = endpoint;
		m_sGraph = graph;
		m_iChunk = chunk;
	}

	public SPARQLQueryEngine(String sEndpoint, int iChunk){
